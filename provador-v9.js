(function () {
    ...
    (function() {
        function injectPLBadge() {
            try {
                ...
                a.href = 'https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=calmo';
                a.target = '_blank';
                a.rel = 'noopener';
                ...
                img.alt = 'Provador Virtual de Roupas com IA — Provou Levou';
    ...
    style.innerHTML = `
        ...
        .q-quantic-logo { height: 28px; filter: brightness(0); }
